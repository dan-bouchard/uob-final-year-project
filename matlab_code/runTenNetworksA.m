...
% loading data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load(['complexity_data/Complexity' num2str(N)]);
...
%     [networks2.(fields{i}), sim_data.(fields{i})] = simulate_ms_sys(smallNetworks.(fields{i}),U);
    [networks2.(fields{i}), sim_data.(fields{i})] = simulate_hysteresis_sys(smallNetworks.(fields{i}),U);
%     [networks2.(fields{i}), sim_data.(fields{i})] = simulate_maxwell_sys(smallNetworks.(fields{i}), U);
end

save(['files/smallNets_complexity_hys/networks2_N_' num2str(N)],'networks2');
save(['files/smallNets_complexity_hys/sim_data_N_' num2str(N)],'sim_data');
