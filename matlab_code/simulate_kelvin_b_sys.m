function [net_after,sim_data] = simulate_kelvin_b_sys(net,input,output)
...
%  	   d = d + net.dist_noise*rand(1,1);%-net.dist_noise*0.5;
	...
	% Calculate extensions
       ...
       x2_ext = W.x2_ext_old(c,1) + time_step*x2_dot; %x2(i+1)
	   ...
	   F_pee = W.kp3(c,1)*(x-x2_ext)^3 + W.kp1(c,1)*(x-x2_ext);
       F_see = W.k3(c,1)*x2_ext^3 + W.k1(c,1)*x2_ext;
       % F_sde = W.d3(c,1)*x1_dot^3 + W.d1(c,1)*x1_dot;
