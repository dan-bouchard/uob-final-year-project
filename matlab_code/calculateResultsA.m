...
load(['files/smallNets_complexity_hys/networks2_N_' num2str(N)]);
load(['files/smallNets_complexity_hys/sim_data_N_' num2str(N)]);
...
save(['files/smallNets_complexity_hys/Error_N_' num2str(N)],'Error');
%x=N*ones(10,1);
