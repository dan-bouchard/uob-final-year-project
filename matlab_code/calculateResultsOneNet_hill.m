function [] = calculateResultsOneNet_hill(N, network_num)
...
load(['files/smallNets_hill_activation/networks2_hill_net_' num2str(network_num) '_N_' num2str(N)]);
load(['files/smallNets_hill_activation/sim_data_hill_net_' num2str(network_num) '_N_' num2str(N)]);
...
save(['files/smallNets_hill_activation/Error_hill_net_' num2str(network_num) '_N_' num2str(N)],'Error');
