function [] = calculateResultsOneNet_hill_NARMA(N, network_num)
...
load(['files/smallNets_NARMA_hill/networks2_hill_net_' num2str(network_num) '_N_' num2str(N)]);
load(['files/smallNets_NARMA_hill/sim_data_hill_net_' num2str(network_num) '_N_' num2str(N)]);
...
save(['files/smallNets_NARMA_hill/Error_hill_net_' num2str(network_num) '_N_' num2str(N)],'Error');
